...
# set_directive_pipeline "lif_neuron<TI, TO, SZ>::compute"
# set_directive_array_partition -type complete -dim 1 "lif_top" indata
...
puts [ read [ open "lif_prj/solution1/syn/report/${top_fn_name}_csynth.rpt" r ]]
